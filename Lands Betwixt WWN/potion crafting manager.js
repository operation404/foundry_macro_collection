...
const potion_presets = {
    ...
    "Acid Vial":            {"dc" : 10, "cost": 50,  "time": 1},
    "Binding Paste":        {"dc" : 9,  "cost": 50,  "time": 1},
    "Blinding Dust":        {"dc" : 9,  "cost": 50,  "time": 2},
    "Healing Salve":        {"dc" : 7,  "cost": 10,  "time": 1},
    "Incandescent Dust":    {"dc" : 9,  "cost": 500, "time": 1},
    "Inflammable Oil":      {"dc" : 8,  "cost": 100, "time": 1},
    "Itching Dust":         {"dc" : 9,  "cost": 100, "time": 2},
    "Luminescent Oil":      {"dc" : 8,  "cost": 50,  "time": 1},
    "Self-Igniting Oil":    {"dc" : 8,  "cost": 50,  "time": 3},
    "Smoke Cloud":          {"dc" : 9,  "cost": 25,  "time": 2},
    "Soothing Powder":      {"dc" : 8,  "cost": 25,  "time": 2},
    "Touchstone":           {"dc" : 10, "cost": 50,  "time": 3},

    // Atlas of latter earth greater works
    "Aqueous Solvent":      {"dc" : 11, "cost": 250,  "time": 5},
    "Courage Elixir":       {"dc" : 10, "cost": 200,  "time": 7},
    "Infernal Wind":        {"dc" : 11, "cost": 250,  "time": 7},
    "Lethal Poison":        {"dc" : 11, "cost": 500,  "time": 7},
    "Revivifying Draught":  {"dc" : 10, "cost": 200,  "time": 7},
    "Sleeping Powders":     {"dc" : 10, "cost": 200,  "time": 3},
    "Sovereign Specific":   {"dc" : 11, "cost": 200,  "time": 7},
    "Unquenchable Flame":   {"dc" : 12, "cost": 1000, "time": 14},
};
...
const custom_dialog = new Dialog({
    ...
    content: `
        <form>
            ...
            <div class="form-group" style="flex-direction: row;">
                ...
                <input type="checkbox" id="rushed" title="While rushing, 2 days of progress are made for every 1 real day, and a skill check is made at the end to determine if the potion is crafted." ${potion_crafting.rushed.value ? `checked` : ``}>
                <div></div>
            </div>
            <hr>
    ...
    render: (html) => {
        ...
        document.getElementById("progress_button").addEventListener("click", (e) => {
            const progressed_days = parseInt(document.getElementById("days_to_progress").value) * (document.getElementById("rushed").checked ? 2 : 1);
